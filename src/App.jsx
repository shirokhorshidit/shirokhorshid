...
const content = {
  fa: {
    ...
    paragraphs: [
      ...
      '«جبهه شیر و خورشید ایتالیا» که همزمان با نوروز ۲۵۸۵ شاهنشاهی و زادروز پیام‌آور مهر و هویت ایرانی، آشو زرتشت، اعلام موجودیت می‌کند، مبتنی بر چهار اصل خلل‌ناپذیر اعلامی از سوی شاهزاده رضا پهلوی است و این جبهه خود را بخشی از سازوکار همکاری ملی و پشتیبان «سامانه گذار» می‌داند.',
  ...
  en: {
    ...
    paragraphs: [
      'Dear compatriots,',
      'We, a diverse group of political activists, students, and graduates residing in Italy, in view of the grave and historic conditions of our homeland, have decided to establish the “Lion and Sun Front Italy” in order to take a major step toward organizing the activities of the Iranian diaspora in Italy; and hereby announce the establishment of this front and the commencement of its activities.',
      'The social and political developments in Iran in recent years have shown that the role of national, conscious, and responsible forces, especially the younger generation, has been and will remain decisive in shaping the future course of the country. Under such circumstances, the need for a coherent platform for collective thinking and effective action is felt more strongly than ever.',
      'With emphasis on the historic role and leadership of Crown Prince Reza Pahlavi, we will strive to bring together concerned Iranians in Italy under the broad umbrella of this organization and to play an effective role in advancing the demands for freedom of the Iranian nation in this country.',
      'The “Lion and Sun Front Italy,” which is established simultaneously with Nowruz 2585 of the Imperial Calendar and the birth anniversary of Asho Zartosht, the herald of Iranian identity and values, are founded on the four inviolable principles announced by Crown Prince Reza Pahlavi. This front also considers itself part of the framework of national cooperation and a supporter of the “Transition Platform.”',
      'We regard ourselves as committed to the fundamental principles of nationalism, democratic practices, transparency, and dialogue; and we emphasize honesty, accountability, meritocracy, and the rejection of all forms of discrimination and exclusionary behavior.',
